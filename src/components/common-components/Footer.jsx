            ...
            <div className="container">
                <div className="social-area">
                    ...
                    <div className="social-icons">
                        <a href="https://github.com/armanahsanhabib" target="_blank" rel="noreferrer"><i class="fa-brands fa-github"></i></a>
                        <a href="https://www.linkedin.com/in/sheikh-ahsan-habib-arman-bb874920b/" target="_blank" rel="noreferrer"><i class="fa-brands fa-linkedin"></i></a>
                        <a href="https://www.facebook.com/arman.ahsanhabib/" target="_blank" rel="noreferrer"><i class="fa-brands fa-facebook"></i></a>
                        <a href="https://twitter.com/SheikhAhsanHab3" target="_blank" rel="noreferrer"><i class="fa-brands fa-twitter"></i></a>
                        <a href="https://www.youtube.com/@armanahsanhabib" target="_blank" rel="noreferrer"><i class="fa-brands fa-youtube"></i></a>
                    </div>
                </div>
                <div className="contact-details">
                    ...
                    <div className="columns">
                        <div className="col">
                            <h3><i class="fa-solid fa-envelope"></i> SENT MAIL</h3>
                            <div className="mail">
                        ...
                        <div className="col">
                            <h3><i class="fa-solid fa-phone"></i> MAKE CALL</h3>
                            <div className="phone">
